    ...
    <div className="flex justify-center pt-10">
      ...
      className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
        ...
        <div className="mb-5">
          ...
          {errors.name?.type === 'minLength' && <p className="text-red-500">This field is required to be at least 3 characters</p>}
        </div>
        ...
        <div className="mb-5">
          ...
          {errors.subject?.type === 'minLength' && <p className="text-red-500">This field is required to be at least 3 characters</p>}
        ...
        <div className="mb-5">
          ...
          {errors.email?.type === 'pattern' && <p className="text-red-500">This field is required to be a valid email</p>}
        </div>
        <div className="mb-5">
          ...
          <input 
            ...
            {errors.body?.type === 'required' && <p className="text-red-500">This field is required</p>}  
            {errors.body?.type === 'minLength' && <p className="text-red-500">This field is required to be at least 3 characters</p>}
